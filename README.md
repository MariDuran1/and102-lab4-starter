...
Submitted by: **Marimar Duran** <!-- Replace 'Your Name Here' with your actual name -->
...
- [x] (3 pts) **Articles are displayed using the RecyclerView.**
  - ![Image/GIF showing RecyclerView implementation](walkthrough.gif) <!-- Replace this link with your actual image/GIF link -->

- [x] (4 pts) **Can navigate to the Article Details screen.**
  - ![Image/GIF showing Article Details screen](walkthrough.gif) <!-- Replace this link with your actual image/GIF link -->

- [x] (3 pts) **Article images are downloaded and displayed using Glide.**
  - ![Image/GIF showing Glide usage](walkthrough.gif) <!-- Replace this link with your actual image/GIF link -->
...
## Notes
Main challenge I had was figuring out the api key properties with the build config. Once that was figured out everything else was smooth sailing but definitely had to do a bit of debugging. 
